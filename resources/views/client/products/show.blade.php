    ...
    <div id="container">
        <div class="container">
            ...
            <ul class="breadcrumb">
                ...
                <li itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><a href="#" itemprop="url"><span itemprop="title">{{$product->category->title_fa}}</span></a></li>
                ...
                <div id="content" class="col-sm-9">
                    <div itemscope itemtype="http://schema.org/محصولات">
                        ...
                        <div class="row product-info">
                            <div class="col-sm-6">
                                <div class="image"><img class="img-responsive" itemprop="image" id="zoom_01" src="{{str_replace('public','/storage',$product->image)}}" title="لپ تاپ ایلین ور" alt="لپ تاپ ایلین ور" data-zoom-image="{{str_replace('public','/storage',$product->image)}}" /> </div>
                                ...
                                <div class="image-additional" id="gallery_01">
                                    ...
                                    <a class="thumbnail" href="#" data-zoom-image="{{str_replace('public','/storage',$product->image)}}" data-image="{{str_replace('public','/storage',$product->image)}}" title="{{$product->name}}">
                                        <img src="{{str_replace('public','/storage',$product->image)}}" title="{{$product->name}}" alt ="{{$product->name}}"/>
                                    </a>

                                    @foreach($product->galleries as $gallery)
                                    <a class="thumbnail" href="#" data-zoom-image="{{str_replace('public','/storage',$gallery->path)}}" data-image="{{str_replace('public','/storage',$gallery->path)}}" title="{{$gallery->product->name}}">
                                        <img src="{{str_replace('public','/storage',$gallery->path)}}" title="{{$gallery->product->name}}" alt ="{{$gallery->product->name}}"/>
                                    </a>
                                    @endforeach
                                </div>
                            </div>
                                ...
                                <div id="tab-specification" class="tab-pane">
                                    @foreach($propertyGroups as $propertyGroup)
                                         <table class="table table-bordered">
                                             <thead>
                                             <tr>
                                                 <td colspan="2"><strong>{{$propertyGroup->title}}</strong></td>
                                             </tr>
                                             </thead>
                                             <tbody>
                                             @foreach($propertyGroups->properties as $property)
                                                 <tr>
